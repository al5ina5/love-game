...
# 1.5. Detect deployer's local IP address and create .env file
echo "[1.5/6] Detecting deployer IP and creating .env file..."
DEPLOYER_IP=""
...
# Create .env file with deployer's IP for API
cat > .env << EOF
...
echo "✓ Created .env file with deployer IP"
echo ""
